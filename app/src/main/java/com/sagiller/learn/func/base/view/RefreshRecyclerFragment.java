 ...
 */
public abstract class RefreshRecyclerFragment<M extends List<? extends Parcelable>, V extends MvpLceView<M>, P extends MvpPresenter<V>>
    extends RefreshFragment< M, V, P> {
